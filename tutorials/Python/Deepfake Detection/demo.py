'''
    This is the demo script for performing Deepfake Classification using Ailiverse APIs
'''
...
email = 'test@ailiverse.com'                        # Email Address for registering
password = "999+++Nxt"                          # Password for registering
organization = "999+++Nxt"                  # Organization Name
...
'''
    ...
    Output:
        - modelID
'''
data =  { "model_type": "DeepFake_Detection"}
